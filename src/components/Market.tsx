    ...
    <section id="market" className="py-24 md:py-32 px-6 relative">
      ...
      <div className="relative z-10 max-w-6xl mx-auto">
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-16">
          <div className="glass-card rounded-2xl p-8 text-center" style={{ borderLeft: "2px solid #E85A1A" }}>
          ...
          <div className="glass-card rounded-2xl p-8 text-center" style={{ borderLeft: "2px solid #1A6BFF" }}>
          ...
          <div className="glass-card rounded-2xl p-8 text-center" style={{ borderLeft: "2px solid #00C27C" }}>
        ...
        <div className="grid md:grid-cols-3 gap-6 mb-20">
          {revenue.map((r, i) => (
            <div key={i} className="glass-card rounded-2xl p-8 text-center">
              <p className="font-display text-5xl font-bold gradient-text mb-2">{r.pct}</p>
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {projections.map((p, i) => (
            <div key={i} className="glass-card rounded-xl p-6 text-center">
              ...
              <p className="font-display text-2xl md:text-3xl font-bold text-white mb-2">{p.arr}</p>
